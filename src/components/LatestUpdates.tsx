            ...
            <div className="relative z-20 flex flex-col-reverse lg:flex-row items-start min-h-[280px] sm:min-h-[320px] md:min-h-[361px] lg:min-h-[320px] xl:min-h-[350px]">
                  ...
                  {featuredManga?.genres ? (
                    featuredManga.genres.slice(0, 5).map((genre, index) => (
                      <Badge key={genre} className={`backdrop-blur-sm text-xs sm:text-sm px-[1.5vw] py-[0.5vh] border border-opacity-30 rounded-full transition-all duration-300 hover:scale-105 ${
                        index === 0 ? 'bg-[#707ff5]/20 text-[#a195f9] border-[#707ff5]/30 hover:bg-[#707ff5]/30 hover:border-[#707ff5]/50' :
                        index === 1 ? 'bg-[#a195f9]/20 text-[#f2a1f2] border-[#a195f9]/30 hover:bg-[#a195f9]/30 hover:border-[#a195f9]/50' :
                        index === 2 ? 'bg-[#f2a1f2]/20 text-[#f2a1f2] border-[#f2a1f2]/30 hover:bg-[#f2a1f2]/30 hover:border-[#f2a1f2]/50' :
                        index === 3 ? 'bg-[#4b4bc3]/20 text-[#a195f9] border-[#4b4bc3]/30 hover:bg-[#4b4bc3]/30 hover:border-[#4b4bc3]/50' :
                        'bg-[#707ff5]/20 text-[#a195f9] border-[#707ff5]/30 hover:bg-[#707ff5]/30 hover:border-[#707ff5]/50'
                      }`}>
                        {genre}
                      </Badge>
                    ))
                    ...
                    <>
                      <Badge className="bg-[#a195f9]/20 backdrop-blur-sm text-[#f2a1f2] text-xs sm:text-sm px-[1.5vw] py-[0.5vh] border border-[#a195f9]/30 rounded-full hover:bg-[#a195f9]/30 hover:border-[#a195f9]/50 transition-all duration-300 hover:scale-105">
                        shoujo
                      </Badge>
                      <Badge className="bg-[#f2a1f2]/20 backdrop-blur-sm text-[#f2a1f2] text-xs sm:text-sm px-[1.5vw] py-[0.5vh] border border-[#f2a1f2]/30 rounded-full hover:bg-[#f2a1f2]/30 hover:border-[#f2a1f2]/50 transition-all duration-300 hover:scale-105">
                        Drama
                      </Badge>
                    </>
                  )}
                ...
                >
                  ...
                  <div className="flex flex-nowrap gap-2 sm:gap-3 md:gap-4 lg:gap-2 xl:gap-3 w-[78.7%] md:w-[58.6%] lg:w-[90.5%] mx-auto">
                    {thumbnailGrid.map((item, index) => (
                      <div
                        key={item.id}
                        className={`cursor-pointer group flex-shrink min-w-0 flex-1 max-w-[86%] transition-all ease-in-out duration-500 ${
                          index === centerIndex 
                      ...
                      >
                        ...
                        <div className="relative w-full aspect-[3/4] rounded-xl overflow-hidden transition-all ease-in-out duration-300 hover:scale-[1.02] ring-1 ring-white/10 shadow-lg backdrop-blur-sm">
                          <img
                          ...
                          <div className="absolute inset-0 pointer-events-none overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent transform -skew-x-12 -translate-x-full opacity-0 group-hover:opacity-100 group-hover:translate-x-full transition-all duration-800 ease-out"></div>
                          </div>
                          
                          {/* Focus indicator ring - Modern manga style */}
                          {index === centerIndex && (
                            <div className="absolute inset-0 rounded-xl ring-2 ring-[#a195f9] shadow-xl shadow-[#a195f9]/60 ring-opacity-100 animate-pulse"></div>
                          )}
                        </div>
                      </div>
                    ))}
              ...
              >
                ...
                <div className="lg:hidden relative flex justify-center -mt-8 sm:-mt-12 md:-mt-16">
                  <div className="w-[55vw] max-w-[240px] h-[73vw] max-h-[320px] sm:w-[45vw] sm:max-w-[300px] sm:h-[60vw] sm:max-h-[400px] md:w-[31.8vw] md:max-w-[302px] md:h-[42.7vw] md:max-h-[403px] rounded-2xl overflow-hidden shadow-2xl relative group cursor-pointer ring-2 ring-white/10 transition-all duration-500">
