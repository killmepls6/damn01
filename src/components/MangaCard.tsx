...
export default function MangaCard({
  ...
  return (
    <div 
      className="group bg-card rounded-lg overflow-hidden border border-card-border hover-elevate transition-all duration-300 relative"
    ...
    >
      ...
      <div className="group/cover relative aspect-[3/4] overflow-hidden cursor-pointer" onClick={onClick}>
        ...
        <div className="absolute inset-0 z-10 pointer-events-none opacity-0 group-hover/cover:opacity-100 transition-opacity duration-300 overflow-hidden">
        ...
        {/* Hover Content */}
        <div className="absolute bottom-2 left-2 right-2 z-20 opacity-0 group-hover/cover:opacity-100 transition-opacity duration-300">
